...
class PropertySizePage extends StatefulWidget {
  ...
  final id,token;
  PropertySizePage({required this.selectedPropertyType,required this.numberofrooms,required this.id,required this.token});
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => PropertyImagesPage(selectedPropertyType: widget.selectedPropertyType,
                          numberofrooms: widget.numberofrooms,numberofbeds:numberOfBeds,size:propertySize,id:widget.id,token:widget.token),
                      ),
                    );
                  } else {
