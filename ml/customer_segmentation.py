...
# Load the dataset
users_cursor = db.users_collection.find({"type": {"$ne": "admin"}})

users_cursor_df = pd.DataFrame(list(users_cursor))

users_interests_df = users_cursor_df[["_id", "hobbies_pastimes", "sports_activities", "cultural_artistic", "intellectual_academic"]]

# Drop non-numeric columns
numeric_data = users_interests_df.drop(columns=['_id'])
...
users_interests_df['cluster'] = cluster_labels
